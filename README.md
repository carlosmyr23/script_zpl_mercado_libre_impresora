...
```
cd existing_repo
git remote add origin https://gitlab.com/carlosmyr231/script_zpl_mercado_libre_impresora.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/carlosmyr231/script_zpl_mercado_libre_impresora/-/settings/integrations)
